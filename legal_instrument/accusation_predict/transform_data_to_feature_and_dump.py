...
def dump_data_for_cnn():
    ...
    print("reading data from training set...")
    train_data_x, train_data_y = matrix_generator.read_data_in_accu_format(constant.DATA_TRAIN, embedding, 10,
                                                                    word_dict, accu_dict, one_hot=True)
    valid_data_x, valid_data_y = matrix_generator.read_data_in_accu_format(constant.DATA_VALID, embedding, 10,
                                                                    word_dict, accu_dict, one_hot=True)
    test_data_x, test_data_y = matrix_generator.read_data_in_accu_format(constant.DATA_TEST, embedding, 10,
                                                                    word_dict, accu_dict, one_hot=True)
    print("reading complete!")
